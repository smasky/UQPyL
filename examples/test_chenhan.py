...
asmo = ASMO(nInit=100, optimizer=ga, surrogate=srg, maxTolerateTimes=1000, verboseFlag=True, verboseFreq=1, logFlag=False, saveFlag=True)

res = asmo.run(problem, oneStep=False)