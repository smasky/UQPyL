...
# print("################2.FAST################")
# from UQPyL.sensibility import FAST
# fast_method=FAST(M=4, verbose=True, saveFlag=True, logFlag=True)
# X=fast_method.sample(problem, 500)
# Y=problem.evaluate(X)
# Si=fast_method.analyze(problem, X, Y)
# a=1
# ###############3. RBD_FAST#################
# print("##############3.RBD_FAST##############")
# rbd_method=RBD_FAST(M=4, verbose=True, saveFlag=True, logFlag=True)
# X=rbd_method.sample(problem, 1000)
# Y=problem.evaluate(X)
# Si=rbd_method.analyze(problem, X, Y)
# a=1
