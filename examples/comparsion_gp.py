...
database = pd.read_excel("./database_gp.xlsx", index_col=0)
#----------------------GP-----------------------------#
    ...
    for dim in dimensions:
        for sample in samples:
            for time in range(20):
                ...
                database.loc[len(database)]=[problem.__class__.__name__, 'GP-L2', index, time,dim, sample, r2, rank]
            index+=1
    database.to_excel("./database_gp.xlsx")